package com.team214.nycue4.client

import android.content.Context
import androidx.preference.PreferenceManager
import android.util.Log
import com.team214.nycue4.model.*
import com.team214.nycue4.utility.unescapeHtml
...
class NewE3ApiClient(context: Context) : E3Client() {
    ...
    private fun post(
        ...
        return Observable.fromCallable {
            ...
            Request.Builder().url(API_URL).post(formBody).build()
